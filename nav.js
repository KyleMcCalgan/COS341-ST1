(() => {
  ...
  drawer.innerHTML = `<div class="nav-drawer-head"><div><span class="nav-drawer-kicker">COS341</span><strong>Course map</strong></div><button type="button" class="nav-close" aria-label="Close menu">×</button></div>
    <div class="nav-tree">
      ...
      ${folder('Completed Homework', link('homework/index.html', 'Homework index') + link('homework/homework-3.html', 'Homework 3 · SLR parsing') + link('homework/gotos-to-dfa-walkthrough.html', 'Homework 3 · GOTOs to DFA'))}
    </div>
